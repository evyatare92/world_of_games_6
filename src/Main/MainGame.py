...
def game_picker():
    return  "" + "\n" \
            ...
            "		{" + "\n" \
            "			case 'memorygame':" + "\n" \
            "				url = 'http://'+ window.location.hostname + ':30001/memorygame';" + "\n" \
            "				break;" + "\n" \
            "			case 'guessgame':" + "\n" \
            "				url = 'http://'+ window.location.hostname + ':30002/guessgame';" + "\n" \
            "				break;" + "\n" \
            "			case 'currecyrollete':" + "\n" \
            "				url = 'http://'+ window.location.hostname + ':30003/currecyrollete';" + "\n" \
            "				break;" + "\n" \
            "			case 'score':" + "\n" \
            "				url = 'http://'+ window.location.hostname + ':30004/getscore';" + "\n" \
            "				break;" + "\n" \
            "		}" + "\n" \
